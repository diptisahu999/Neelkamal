...
class InheritStockPicking(models.Model):
    ...
    def _compute_return_count(self):
        ...
        for line in self:
            line.invoices_count = len(self.env['account.move'].search(['|',('invoice_picking_id', '=', line.id),('name', '=', line.origin),('move_type', '=', 'in_invoice')]))
        return res
    ...
    def action_view_invoices(self):
        ...
        account_move = self.env['account.move'].sudo().search(['|',('invoice_picking_id', '=', self.id),('name', '=', self.origin),('move_type', '=', 'in_invoice')])
